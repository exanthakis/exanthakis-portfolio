...
const Button = ({ buttonType, href, children, ...props }: ButtonProps) => {
  const classes =
    buttonType === ButtonType.SECONDARY
      ...
      ? "group bg-white text-black active:scale-105 transition border border-black/10 dark:bg-white/10 dark:text-white/60 hover:bg-white/90 px-7 py-2 shadow-[0_6px_16px_rgba(255,255,255,.2)] hover:shadow-[0_6px_20px_rgba(255,255,255,.4)]"
